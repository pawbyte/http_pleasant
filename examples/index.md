...
int main( int argc, char** argv )
{
	...
	system("pause");
	std::string download_url = "http://google.com/"; //Replace Google.com with a file located ONLY ON A HTTP(NON-SECURE SITE), SSL IS NOT YET SUPPORTED
